...
github_doc_root = 'https://github.com/zcattacz/pjon_doc/master/'
...
man_pages = [
    (master_doc, 'pjon_doc', u'PJON Wiki',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pjon_doc', u'PJON Wiki',
   author, 'pjon_doc', 'PJON - Padded Jittering Operative Network.',
   'network'),
]
...
# app setup hook
def setup(app):
    app.add_config_value('pjon_doc_config', {
